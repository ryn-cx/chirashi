# TODO: Validate
"""Rebuilds every Chirashi model from the responses recorded under `_files`.
...
# TODO: Validate
def generate_all(client: Chirashi) -> None:
...
if __name__ == "__main__":
    ...
    generate_all(Chirashi(build_client_automatically()))
